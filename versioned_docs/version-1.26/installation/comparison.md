...
[Forgente](https://forgente.com) is a soft fork of Gitea that closely tracks upstream, so it inherits every feature in the Gitea column and its releases are based on the matching Gitea version (e.g. Forgente v1.26.4-1 is based on Gitea 1.26.4). The Forgente column reflects its current status and will be updated as the two diverge.
...
| Feature                                          | Forgente                                            | Gitea                                               | GitHub EE | GitLab CE | GitLab EE | BitBucket | RhodeCode CE | RhodeCode EE |
| ------------------------------------------------ | --------------------------------------------------- | --------------------------------------------------- | --------- | --------- | --------- | --------- | ------------ | ------------ |
...
| RSS Feeds                                        | ✓                                                   | ✓                                                   | ✓         | ✘         | ✘         | ✘         | ✓            | ✓            |
| Built-in CI/CD                                   | ✓                                                   | ✓                                                   | ✓         | ✓         | ✓         | ✘         | ✘            | ✘            |
| Subgroups: groups within groups                  | [✘](https://github.com/go-gitea/gitea/issues/1872)  | [✘](https://github.com/go-gitea/gitea/issues/1872)  | ✘         | ✓         | ✓         | ✘         | ✓            | ✓            |
| Interaction with other instances                 | [/](https://github.com/go-gitea/gitea/issues/18240) | [/](https://github.com/go-gitea/gitea/issues/18240) | ✘         | ✘         | ✘         | ✘         | ✘            | ✘            |
...
| Projects                      | [/](https://github.com/go-gitea/gitea/issues/14710) | [/](https://github.com/go-gitea/gitea/issues/14710) | ✘         | ✓         | ✓         | ✘         | ✘            | ✘            |
| Create branch from issue      | [✘](https://github.com/go-gitea/gitea/issues/20226) | [✘](https://github.com/go-gitea/gitea/issues/20226) | ✘         | ✓         | ✓         | ✘         | ✘            | ✘            |
...
| Merge conflict resolution                       | [✘](https://github.com/go-gitea/gitea/issues/9014) | [✘](https://github.com/go-gitea/gitea/issues/9014) | ✓         | ✓         | ✓         | ✓         | ✘            | ✘            |
...
| SAML 2.0 service provider                      | [✘](https://github.com/go-gitea/gitea/issues/5512) | [✘](https://github.com/go-gitea/gitea/issues/5512) | ✓         | ✓         | ✓         | ✓         | ✘            | ✓            |
