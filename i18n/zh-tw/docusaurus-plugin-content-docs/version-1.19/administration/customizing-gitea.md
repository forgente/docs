...
- [快速备忘单](https://docs.gitea.io/zh-tw/config-cheat-sheet/)
...
- [环境变量清单](https://docs.gitea.io/zh-tw/specific-variables/)
...
`app.ini` [ui](https://docs.gitea.io/zh-tw/config-cheat-sheet/#界面) 部分的 `DEFAULT_THEME` 的值来变更至一个可用的 Gitea 外观。
