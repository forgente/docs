...
为了定制特定操作的电子邮件主题和内容，可以使用模板来自定义 Gitea。这些功能的模板位于 [`custom` 目录](https://docs.gitea.io/zh-tw/customizing-gitea/) 下。
...
如果遇到问题，请检查 [Gitea 的日志](https://docs.gitea.io/zh-tw/logging-configuration/) 以获取错误消息。
